...
::youtube{id="65EkdANRFS0" title="Berny Compressor V4, cuando se cuida cada detalle | Review en español"}
::

::affiliate{url="https://s.click.aliexpress.com/e/_EzNQdLO" store="aliexpress" label="Click aquí para comprarlo en Aliexpress"}
::

::affiliate{url="https://amzn.to/49PLCVi" store="amazon" label="Click aquí para comprarlo en Amazon"}
::

## Diseño: un diver con mucha personalidad
...
## Correa de silicona muy bien ejecutada
...
## Caja de acero con carácter industrial
...
## Cristal de zafiro y tapa vista
