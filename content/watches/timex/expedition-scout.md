...
::youtube{id="hCIP-qdGnIc" title="Timex Expedition Scout, reloj de campo para el aventurero moderno | Review en español"}
::

::affiliate{url="https://amzn.to/46i0V6T" store="amazon" label="Click aquí para comprarlo en Amazon"}
::
...
## Calibre y ese “tic” tan característico
...
## Correa de cuero y hebilla bien resuelta
...
## Caja de latón: clásica y diferente
...
## Manecillas y un toque de color
