<template>
  <div class="index-container">
    ...
    <div class="card-container">
      <NuxtLink :to="post.url" v-for="post in news" :key="post.id" class="news-card" :style="{ backgroundImage: 'url(../_nuxt/assets/img/watches' + post.image + ')' }">
    ...
    <h2>Relojes</h2>
    <div class="card-container">
      <div v-for="post in news" :key="post.id" class="news-card" :style="{ backgroundImage: 'url(../_nuxt/assets/img/watches' + post.image + ')' }">
        <p class="brand">{{ post.brand }}</p>
        <p class="model">{{ post.model }}</p>
      </div>
    </div>
